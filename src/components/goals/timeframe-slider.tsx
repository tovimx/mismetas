...
const timeframes = [
  ...
  {
    index: 7,
    value: { value: 0, unit: 'end-of-year' },
    label: 'End of year',
    description: 'By December 31st',
  },
  {
    index: 8,
    value: { value: 3, unit: 'year' },
    label: '3 years',
    description: 'Long-term vision',
  },
  {
    index: 9,
    value: { value: 0, unit: 'habit' },
    label: 'Daily Habit',
    description: 'Ongoing practice',
  },
];
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex justify-between items-center">
        <div className="text-sm font-medium">{currentTimeframe.description}</div>
